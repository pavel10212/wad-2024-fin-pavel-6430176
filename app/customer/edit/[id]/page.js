...
export default function EditCustomer({ params }) {
  ...
  useEffect(() => {
    const fetchCustomer = async () => {
      try {
        ...
        setValue('dateOfBirth', new Date(customer.dateOfBirth).toISOString().split('T')[0]);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">Edit Customer</h1>
      <form onSubmit={handleSubmit(updateCustomer)} className="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div className="mb-4">
